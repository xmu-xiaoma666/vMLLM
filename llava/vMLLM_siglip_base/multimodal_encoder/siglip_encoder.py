...
class SigLipVisionTower(nn.Module):
    ...
    def load_model(self, device_map=None):
        ...
        self.tokenizer = SiglipTokenizer.from_pretrained(self.vision_tower_name)
        self.text_tower = SiglipTextModel.from_pretrained(self.vision_tower_name, device_map=device_map)
    ...
    def forward_text(self, text):
        ...
        text_forward_outs = self.text_tower(**inputs.to(self.device), output_hidden_states=True)
        text_features = text_forward_outs.hidden_states[-1]
        
        return text_features, text_forward_outs
